...
{
    public class OffRoad : Auto, IInit
    {
        ...
        public OffRoad(string brand, int year, string color, int cost, int clearance, string pathType) : base(brand, year, color, cost, clearance)
        {
            this.FourWD = fourWD;
        ...
        public override bool Equals(object obj)
        {
            ...
            OffRoad otherOff_road = (OffRoad)obj;
        ...
        {
            OffRoad clone = (OffRoad)base.Clone();
